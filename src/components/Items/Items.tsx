  ...
  return (
    <section className={styles.section05}>
      ...
      <div className={`${styles.section05Col} ${styles.section05ColActive}`}>
        ...
        <img className={`${styles.section05RowImageLeft} ${styles.section05RowImageLeft_1}`} src="./assets/item1.png" alt="alt text" />
      </div>
      ...
      <div className={styles.section05Col}>
        ...
        <img className={`${styles.section05RowImageLeft} ${styles.section05RowImageLeft_2}`} src="./assets/item2.png" alt="alt text" />
      </div>
      ...
      <div className={styles.section05Col}>
        ...
        <img className={`${styles.section05RowImageLeft} ${styles.section05RowImageLeft_3}`} src="./assets/item3.png" alt="alt text" />
      ...
      <div className={styles.section05Col}>
        ...
        <img className={`${styles.section05RowImageLeft} ${styles.section05RowImageLeft_4}`} src="./assets/item4.png" alt="alt text" />
      </div>
      ...
      <div className={styles.section05Col}>
        ...
        <img className={`${styles.section05RowImageLeft} ${styles.section05RowImageLeft_5}`} src="./assets/item5.png" alt="alt text" />
      </div>
